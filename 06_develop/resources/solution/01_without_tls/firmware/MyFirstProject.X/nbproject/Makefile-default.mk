...
${OBJECTDIR}/_ext/254263464/drv_ba414e.o: ../src/config/default/driver/ba414e/src/drv_ba414e.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -DWOLFSSL_IGNORE_FILE_WARN -DHAVE_CONFIG_H -I"../src/third_party/rtos/FreeRTOS/Source/portable/MPLAB/PIC32MZ" -I"../src/third_party/rtos/FreeRTOS/Source/include" -I"../src/third_party/paho.mqtt.embedded-c" -I"../src/config/default/driver/wifi/pic32mzw1/include/" -I"../src/third_party/wolfssl/wolfssl" -I"../src/third_party/wolfssl" -I"../src" -I"../src/config/default" -I"../src/packs/PIC32MZ1025W104132_DFP" -I"../src/config/default/library" -I"../src/config/default/library/tcpip/src" -I"../src/config/default/library/tcpip/src/common" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/254263464/drv_ba414e.o.d" -o ${OBJECTDIR}/_ext/254263464/drv_ba414e.o ../src/config/default/driver/ba414e/src/drv_ba414e.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
...
${OBJECTDIR}/_ext/254263464/drv_ba414e.o: ../src/config/default/driver/ba414e/src/drv_ba414e.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/254263464/drv_ba414e.o.d 
	@${RM} ${OBJECTDIR}/_ext/254263464/drv_ba414e.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -DWOLFSSL_IGNORE_FILE_WARN -DHAVE_CONFIG_H -I"../src/third_party/rtos/FreeRTOS/Source/portable/MPLAB/PIC32MZ" -I"../src/third_party/rtos/FreeRTOS/Source/include" -I"../src/third_party/paho.mqtt.embedded-c" -I"../src/config/default/driver/wifi/pic32mzw1/include/" -I"../src/third_party/wolfssl/wolfssl" -I"../src/third_party/wolfssl" -I"../src" -I"../src/config/default" -I"../src/packs/PIC32MZ1025W104132_DFP" -I"../src/config/default/library" -I"../src/config/default/library/tcpip/src" -I"../src/config/default/library/tcpip/src/common" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/254263464/drv_ba414e.o.d" -o ${OBJECTDIR}/_ext/254263464/drv_ba414e.o ../src/config/default/driver/ba414e/src/drv_ba414e.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/254263464/drv_ba414e.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
